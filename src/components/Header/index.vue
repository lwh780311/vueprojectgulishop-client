...
export default {
  ...
  methods:{
    toSearch(){
      ...
      //传递的params参数，会被路径后面的:xxx匹配，并且xxx就会收集到传过来的params参数
      //最终这个参数，会被放到当前这个路由对象的params属性中

      //query参数是在路径后面，以？分割， ？后面的 a=b&c=d就是你的query参数
      //query参数不属于路径的一部分，路由匹配的时候，不需要关心我这个参数
      //query参数在匹配的时候也会被收集到当前这个路由对象的query属性里面中
